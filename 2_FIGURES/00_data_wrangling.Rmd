...
if (file.exists("CR2016.rds")) {
  ...
  # If it's not saved locally, read it from Google Sheets and save it locally
CR2016 <- read_sheet('https://docs.google.com/spreadsheets/d/1sMcEOIzxPTUZ93-pTJBE0lQ3SI8kKihLZRdpZ32_Lyw/edit?gid=2119695334#gid=2119695334
', sheet = 2)
...
if (file.exists("CR2015.rds")) {
  ...
  tryCatch({
    github_url <- "https://raw.githubusercontent.com/mfmanberg/HAB2/main/1_LIB/1_0_data_wrangling/1_0_2_data/1_0_2_2_data_wrangling/CR2015.rds"
    CR2015 <- readRDS(url(github_url))
    saveRDS(CR2015, "CR2015.rds")
  }, error = function(e) {
    # If GitHub load fails, fallback to Google Sheets
...
#CR2015
   ...
   ## Define path
local <- "C:/Users/mfman/OneDrive/Desktop/HAB2/HAB2/1_LIB/1_0_data_wrangling/1_0_2_data/1_0_2_2_data_wrangling/CR2015.rds"
github_url <- "https://raw.githubusercontent.com/mfmanberg/HAB2/main/1_LIB/1_0_data_wrangling/1_0_2_data/1_0_2_2_data_wrangling/CR2015.rds"
  
  if (file.exists(local_path)) {
  # If it's saved locally, load the data
  CR2015 <- readRDS(local_path)
} else {
  # Try loading from GitHub
  tryCatch({
    CR2015 <- readRDS(url(github_url))
    saveRDS(CR2015, local_path)
  }, error = function(e) {
    # If GitHub load fails, fallback to Google Sheets
    CR2015 <- read_sheet('https://docs.google.com/spreadsheets/d/1t5joquxku9OfQGDdsabp-GdR2sUw8hPDcwatC3SL90Q/edit?usp=sharing', sheet = 2)
    saveRDS(CR2015, local_path)
...
if (file.exists("df_CR.rds")) {
  # If it's saved locally, load the data2
