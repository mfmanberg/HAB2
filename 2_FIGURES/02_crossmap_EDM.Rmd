...
cmap.ph.phy <- CCM(dataFrame = ag_df_CR, E = 6, tau=-tau_ccm, Tp = 0, columns = "ph", target = "phy", libSizes = "20 40 60 80 100 140 180 240 300 400 500 600 700 800 900 1000 1100 1200 1300 1339", sample = 100, exclusionRadius = tau_ccm, random = TRUE, showPlot = TRUE) 
...
cmap.Celsius.phy <- CCM(dataFrame = ag_df_CR, E = 6, tau=-tau_ccm, Tp = 0, columns = "Celsius", target = "phy", libSizes = "20 40 60 80 100 140 180 240 300 400 500 600 700 800 900 1000 1100 1339", sample = 100, exclusionRadius = tau_ccm, random = TRUE, showPlot = TRUE) 
...
abline(h = critical.r(1374), col = "darkgreen", lty = 2)
...
cmap.spcond.phy <- CCM(dataFrame = ag_df_CR, E = 6, tau=-tau_ccm, Tp = 0, columns = "spcond", target = "phy", libSizes = "20 40 60 80 100 140 180 240 300 400 500 600 700 800 900 1000 1100 1339", sample = 100, exclusionRadius = tau_ccm, random = TRUE, showPlot = TRUE) 
...
#do 
cmap.do.phy <- CCM(dataFrame = ag_df_CR, E = 6, tau=-tau_ccm, Tp = 0, columns = "do", target = "phy", libSizes = "20 40 60 80 100 140 180 240 300 400 500 600 700 800 900 1000 1100 1339", sample = 100, exclusionRadius = tau_ccm, random = TRUE, showPlot = TRUE) 
...
cmap.turb.phy <- CCM(dataFrame = ag_df_CR, E = 6, tau=-tau_ccm, Tp = 0, columns = "turb", target = "phy", libSizes = "20 40 60 80 100 140 180 240 300 400 500 600 700 800 900 1000 1100 1339", sample = 100, exclusionRadius = tau_ccm, random = TRUE, showPlot = TRUE) 
...
cmap.Salinity.phy <- CCM(dataFrame = ag_df_CR, E = 6, tau=-tau_ccm, Tp = 0, columns = "Salinity", target = "phy", libSizes = "20 40 60 80 100 140 180 240 300 400 500 600 700 800 900 1000 1100 1339", sample = 100, exclusionRadius = tau_ccm, random = TRUE, showPlot = TRUE) 

cmap.Salinity.phy <- CCM(dataFrame = ag_df_CR, E = 4, tau=-tau_ccm, Tp = 0, columns = "Salinity", target = "phy", libSizes = "20 40 60 100 200 400 600 1000", sample = 10, 
                         includeData = TRUE,
                         exclusionRadius = tau_ccm, random = TRUE, showPlot = TRUE) 
...
cmap.sin_season.phy <- CCM(dataFrame = ag_df_CR, E = 6, tau=-7, Tp = 0, columns = "sin_season", target = "phy", libSizes = "20 40 60 80 100 140 180 240 300 400 500 600 700 800 900 1000 1100 1339", sample = 100, exclusionRadius = tau_i, random = TRUE, showPlot = TRUE) 
...
plot_ccm_result(cmap.ph.phy, "ph", corr_value = ph.phy.corr, critical_corr = critical.r(1374), 
...
plot_ccm_result(cmap.Celsius.phy, "Temperature (°C)", corr_value = Celsius.phy.corr, critical_corr = critical.r(1374), 
