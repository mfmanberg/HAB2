...
cmap.ph.phy <- CCM(dataFrame = ag_df_CR, E = 6, tau=-7, Tp = 0, columns = "ph", target = "phy", libSizes = "20 40 60 80 100 140 180 240 300 400 500 600 700 800 900 1000 1100 1200 1300 1374", sample = 100, exclusionRadius = tau_i, random = TRUE, showPlot = TRUE) 
...
cmap.Celsius.phy <- CCM(dataFrame = ag_df_CR, E = 6, tau=-7, Tp = 0, columns = "Celsius", target = "phy", libSizes = "20 40 60 80 100 140 180 240 300 400 500 600 700 800 900 1000 1100 1339", sample = 100, exclusionRadius = tau_i, random = TRUE, showPlot = TRUE) 
...
cmap.spcond.phy <- CCM(dataFrame = ag_df_CR, E = 6, tau=-7, Tp = 0, columns = "spcond", target = "phy", libSizes = "20 40 60 80 100 140 180 240 300 400 500 600 700 800 900 1000 1100 1339", sample = 100, exclusionRadius = tau_i, random = TRUE, showPlot = TRUE) 
...
#do 
cmap.do.phy <- CCM(dataFrame = ag_df_CR, E = 6, tau=-7, Tp = 0, columns = "do", target = "phy", libSizes = "20 40 60 80 100 140 180 240 300 400 500 600 700 800 900 1000 1100 1339", sample = 100, exclusionRadius = tau_i, random = TRUE, showPlot = TRUE) 
...
cmap.turb.phy <- CCM(dataFrame = ag_df_CR, E = 6, tau=-7, Tp = 0, columns = "turb", target = "phy", libSizes = "20 40 60 80 100 140 180 240 300 400 500 600 700 800 900 1000 1100 1339", sample = 100, exclusionRadius = tau_i, random = TRUE, showPlot = TRUE) 
...
cmap.Salinity.phy <- CCM(dataFrame = ag_df_CR, E = 6, tau=-7, Tp = 0, columns = "Salinity", target = "phy", libSizes = "20 40 60 80 100 140 180 240 300 400 500 600 700 800 900 1000 1100 1339", sample = 100, exclusionRadius = tau_i, random = TRUE, showPlot = TRUE) 
...
cmap.sin_season.phy <- CCM(dataFrame = ag_df_CR, E = 6, tau=-7, Tp = 0, columns = "sin_season", target = "phy", libSizes = "20 40 60 80 100 140 180 240 300 400 500 600 700 800 900 1000 1100 1169", sample = 100, exclusionRadius = tau_i, random = TRUE, showPlot = TRUE) 

sin_season.phy.corr <- cor(cmap.sin_season.phy)
sin_season.phy.corr <- sin_season.phy.corr[1, 3]


sin_season.phy.plot <- plot(x = cmap.sin_season.phy[,1], y = cmap.sin_season.phy[,3], type = "l",
     main = "sin_season V. phy ", xlab = "LibSize", ylab = "Rho", col = "blue",  ylim = c(0, 1))
lines(x = cmap.sin_season.phy[,1], y = cmap.sin_season.phy[,3], col = "red")
lines(x = cmap.sin_season.phy[,1], y = cmap.sin_season.phy[,2], col = "blue")
abline(h = (abs(sin_season.phy.corr)), col = "green", lty = 2)
abline(h = critical.r(1189), col = "darkgreen", lty = 2)
legend("topright", legend = c(colnames(cmap.sin_season.phy)[2:3], "Correlation", 
                              "Critical Correlation"), 
       col = c("blue", "red", "green","darkgreen"), lty = c(1, 1, 2,2))
...
#sin_season 
plot_ccm_result(cmap.sin_season.phy, "Seasonality", 
                corr_value = sin_season.phy.corr, 
                critical_corr = critical.r(1189),
